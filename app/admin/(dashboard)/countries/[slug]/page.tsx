  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="text-xl font-bold text-gray-900 mb-6">
        Editar país — {country.flag} {country.nameEs}
      </h1>
      ...
      <form action={save} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        <div className="grid grid-cols-2 gap-4">
          ...
          <F label="Bandera (emoji)" name="flag" defaultValue={country.flag} required />
        </div>
        ...
        <F label="Nombre en portugués (opcional)" name="namePt" defaultValue={country.namePt ?? ''} />
