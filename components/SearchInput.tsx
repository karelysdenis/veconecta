  ...
  return (
    <div className="relative flex items-center">
      ...
      <input
        ...
        autoComplete="off"
        className="w-full bg-gray-100 rounded-xl pl-9 pr-9 py-2.5 text-[15px] font-sans text-[#141414] placeholder:text-[#808080] focus:outline-none focus:ring-2 focus:ring-caribe/30"
      />
      {value && (
        <button
          type="button"
